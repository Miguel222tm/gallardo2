...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">white DB</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-wrench"></i> Productos <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="agregarProducto.php">Agregar</a>
                            </li>
                            <li>
                                <a href="productos.php">Ver/Editar/Borrar</a>
                            </li>
                        </ul>
                    </li>
                       <li>
                       ...
                       <li>
                        <a href="Facturacion.php"><i class="fa fa-fw fa-money"></i> Facturación</a>
                    </li>
                     <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#faq"><i class="fa fa-fw fa-wrench"></i> FAQ <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="faq" class="collapse">
                            <li>
                                <a href="agregarFAQ.php">Agregar</a>
                            </li>
                            <li>
                      ...
                      <li>
                       ...
                       <li>
                        <a href="../views/adminChat.php"><i class="fa fa-fw fa-wechat"></i> Chat</a>
                    </li>
